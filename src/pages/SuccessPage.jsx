      ...
      <div className="success-container">
        ...
        <div className="success-stats">
          <div className="success-stat">
            ...
            <span className="success-stat__value">25 min</span>
          ...
          <div className="success-stat">
            ...
            <span className="success-stat__value">{dashboardStats.studyStreak.current + 1}</span>
            <span className="success-stat__label">Day Streak</span>
          </div>
          <div className="success-stat success-stat--divider" />
          <div className="success-stat">
            <span className="success-stat__icon">🎯</span>
            <span className="success-stat__value">{dashboardStats.totalSessions + 1}</span>
